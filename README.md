...
## Episode : Fluentbit v3
<p align="center"><img src="/image/fluentibt.png" width="40%" alt="Is It observable Logo" /></p>
This repository contains the files utilized during the tutorial presented in the dedicated IsItObservable episode explaining what is new in Fluentbit v3.
...
```shell
ZONE=europe-west3-a
NAME=isitobservable-fluentbit3
...
### 4.Clone Github repo
```shell
git clone https://github.com/isitobservable/fluentbitv3
cd fluentbitv3
```
